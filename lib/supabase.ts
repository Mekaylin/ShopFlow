...
const supabaseUrl = Constants.expoConfig?.extra?.EXPO_PUBLIC_SUPABASE_URL || (Constants.manifest as any)?.extra?.EXPO_PUBLIC_SUPABASE_URL;
const supabaseAnonKey = Constants.expoConfig?.extra?.EXPO_PUBLIC_SUPABASE_ANON_KEY || (Constants.manifest as any)?.extra?.EXPO_PUBLIC_SUPABASE_ANON_KEY;
